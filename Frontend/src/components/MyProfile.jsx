...
const MyProfile = () => {
  ...
  return (
    <div className="pt-[80px] h-auto w-full flex flex-col   items-center">
     ...
     <div className="w-full md:w-[80%] h-auto flex flex-col md:flex-row p-6 rounded-lg border border-gray-200 bg-[url(https://res.cloudinary.com/djthdoj8n/image/upload/v1736004884/5431981_nxvaf2.jpg)] bg-cover bg-center bg-no-repeat shadow-lg">
  ...
  <div className="flex flex-col md:w-[60%] mt-6 md:mt-0 md:ml-8 justify-center">
    <div className="flex items-center gap-2 text-gray-800">
      ...
      <h1 className="text-2xl font-bold text-white">{currentUser?.firstName}</h1>
    </div>
