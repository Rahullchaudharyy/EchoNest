...
const BlogCard = ({
  ...
  return (
    <div>
      <div key={_id} className={`rounded-lg col-span-1 shadow-xl relative`}>
        <div
          id="Post Image"
        ...
        <div
          id="Post-Details"
          className="relative w-full p-4 flex flex-col gap-4"
        >
          <Link to={`/blog/${_id}`} className="text-xl md:text-xl font-bold">
